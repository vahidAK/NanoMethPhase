...
Update
=============
Support for other methylation callers , in addition to Nanopolsih, including Megalodon, DeepSignal and Tombo has been added to NanoMethPhase. However, note that NanoMethPhase primarily developed using Nanopolish and this is the recommended methylation caller.  
